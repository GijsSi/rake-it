        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Start Raking In Your Data Today
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Rake-it has been the market leader when it comes to data scraping, with out state of the art technology, we can scrape data <span className="underline">undetected</span> and <span className="underline">without risk</span> from <span className="text-indigo-600 font-medium">Instagram.</span>
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              <a
                ...
                {/* <button className='border border-slate-300 hover:border-indigo-600 hover:text-indigo-600 ease-in-out duration-150 font-medium rounded-md px-16 py-4'> Pricing</button> */}
              </a>
            </div>
          </div>
        </div>
